This smart contract built on solidity allows its users to deposit, borrow and lend tokens from the contract. The withdrawal option is available only to the ownner(deployer of the contract). 
